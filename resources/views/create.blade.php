          ...
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data Projek</h5>
                ...
                <form action="{{ route('projek.store') }}" method="post">
                    ...
                    <input class="form-control form-control-solid" id="nama_projek" name="nama_projek" type="text" placeholder="Contoh: Toko Mukena Sejuk Menenangkan" value="{{old('nama_projek')}}">
                    </div>
                    
        
                    <div class="mb-0"><label for="jenisprojeklabel">Jenis Projek</label>
                        <textarea class="form-control form-control-solid" id="jenis_projek" name="jenis_projek" rows="3" placeholder="Cth: Jl Pelajar Pejuan 45">{{old('jenis_projek')}}</textarea>
                    </div>
                    <br>
                    <!-- untuk tombol simpan -->
