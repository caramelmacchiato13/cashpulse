          ...
          <div class="card-body">
            <h5 class="card-title fw-semibold mb-4">Data COA</h5>
                ...
                <form action="{{ route('coa.update', $coa->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="id_coa" value="{{$coa->id}}">
                    <div class="mb-3"><label for="kodeakunlabel">Kode Akun</label>
                    <input class="form-control form-control-solid" id="kode_akun" name="kode_akun" type="text" placeholder="Contoh: 111" value="{{$coa->kode_akun}}"></div>
                    ...
                    <input class="form-control form-control-solid" id="header_akun" name="header_akun" type="text" placeholder="Contoh: 1" value="{{$coa->header_akun}}">
                    </div>
                    <br>
                    <!-- untuk tombol simpan -->
